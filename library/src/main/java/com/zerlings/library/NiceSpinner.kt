...
/*class NiceSpinner(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : AppCompatTextView(context, attrs, defStyleAttr) {
    ...
    init {
        ...
        textTint = typedArray.getColor(R.styleable.NiceSpinner_textTint, getDefaultTextColor(context))
        ...
        arrowDrawableTint = typedArray.getColor(R.styleable.NiceSpinner_arrowTint, ResourcesCompat.getColor(resources, android.R.color.black, null))
        ...
        horizontalAlignment = PopUpTextAlignment.fromId(
            typedArray.getInt(
                R.styleable.NiceSpinner_popupTextAlignment,
